...
export default function Header({
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/90 dark:bg-[#060b16]/85 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800/70 px-4 py-2.5 shadow-sm dark:shadow-[0_4px_24px_rgba(0,0,0,0.4)] transition-colors duration-200">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-base font-extrabold tracking-tight bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-600 dark:from-cyan-400 dark:via-sky-200 dark:to-indigo-300 bg-clip-text text-transparent">
                NER Smart Logistics
              </h1>
              <span className="text-[9px] font-mono font-bold bg-cyan-100 text-cyan-800 border border-cyan-300 dark:bg-cyan-950/80 dark:text-cyan-300 dark:border-cyan-800/60 px-1.5 py-0.2 rounded uppercase">
                v2.4 Live
              </span>
            </div>
        ...
        <div className="flex items-center flex-wrap gap-2">
          ...
          <button
            onClick={toggleTheme}
            className="flex items-center justify-center p-2 rounded-xl bg-slate-100 dark:bg-slate-900/80 hover:bg-slate-200 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white border border-slate-200 dark:border-slate-800 transition-all duration-200 shadow-sm"
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-mono font-bold border transition-all duration-200 shadow-sm ${
              badgeColor === 'emerald'
                ? 'bg-emerald-100 border-emerald-400 text-emerald-800 dark:bg-emerald-950/60 dark:border-emerald-500/60 dark:text-emerald-300 hover:bg-emerald-200 dark:hover:bg-emerald-900/60 shadow-emerald-500/10'
                : badgeColor === 'amber'
                ? 'bg-amber-100 border-amber-400 text-amber-800 dark:bg-amber-950/60 dark:border-amber-500/60 dark:text-amber-300 hover:bg-amber-200 dark:hover:bg-amber-900/60'
                : 'bg-slate-100 border-slate-300 text-slate-600 hover:text-slate-900 hover:bg-slate-200 dark:bg-slate-900/80 dark:border-slate-800 dark:text-slate-400 dark:hover:text-slate-200 dark:hover:bg-slate-800/90'
            }`}
            title={
          ...
          {onRefresh && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-medium bg-slate-100 dark:bg-slate-900/80 hover:bg-slate-200 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white border border-slate-200 dark:border-slate-800 transition-all duration-200 disabled:opacity-50"
              title="Refresh spatial telemetry layers"
            >
              <RefreshCw
                className={`w-3.5 h-3.5 ${
                  isRefreshing ? 'animate-spin text-cyan-600 dark:text-cyan-400' : 'text-slate-500 dark:text-slate-400'
                }`}
              />
          ...
          {isGovOfficial && (
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl text-xs font-medium bg-slate-100 dark:bg-slate-900/80 hover:bg-slate-200 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white border border-slate-200 dark:border-slate-800 transition-all duration-200"
