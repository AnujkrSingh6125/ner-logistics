...
CREATE TABLE public.shipments (
  ...
  cargo_tier TEXT DEFAULT 'TIER_1_CRITICAL',
  cargo_manifest TEXT,
  weight_tons NUMERIC DEFAULT 5.0,
...
('Tezpur Strategic Base', 'Arunachal Pradesh', 'Lohit', 27.9167, 96.1667, 450, 450, 160, 'OPERATIONAL', '+91 94360 66778', true),
...
('HUB-AR-06', 'Tezpur Strategic Base', 'Arunachal Pradesh', 'hub.tezu@nerlogistics.gov.in', 4500, '+91 94360 22006'),
